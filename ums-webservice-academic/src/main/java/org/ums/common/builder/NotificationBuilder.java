...
public class NotificationBuilder implements Builder<Notification, MutableNotification> {
  ...
  @Override
  public void build(JsonObjectBuilder pBuilder, Notification pReadOnly, UriInfo pUriInfo, LocalCache pLocalCache) throws Exception {
  ...
  @Override
  public void build(MutableNotification pMutable, JsonObject pJsonObject, LocalCache pLocalCache) throws Exception {
