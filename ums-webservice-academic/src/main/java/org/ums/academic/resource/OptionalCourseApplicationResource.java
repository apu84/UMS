...
public class OptionalCourseApplicationResource extends MutableOptionalCourseApplicationResource {
  ...
  public JsonObject getStatistics(final @Context Request pRequest, final @PathParam("semester-id") Integer pSemesterId,
  ...
  public JsonObject getCrHrInfo(final @Context Request pRequest, final @PathParam("semester-id") Integer pSemesterId,
      final @PathParam("program-id") Integer pProgramId, final @PathParam("semester") Integer pSemester,
  ...
  public JsonObject getStudentList(final @Context Request pRequest,
      ...
      final @PathParam("status") String pStatus) {
