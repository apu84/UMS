...
import org.ums.academic.resource.helper.SyllabusResourceHelper;
...
public class MutableSyllabusResource extends Resource {
  ...
  public Response updateSyllabus(final @PathParam("object-id") String pObjectId, final @Context Request pRequest,
