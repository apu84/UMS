...
import org.ums.academic.resource.helper.EmpExamInvigilatorDateHelper;
import org.ums.resource.Resource;

/**
 * Created by Monjur-E-Morshed on 7/27/2018.
 */
public class MutableEmpExamInvigilatorDateResource extends Resource {
  EmpExamInvigilatorDateHelper mHelper;
  /*
   * @POST
   * 
   * @Path("/addRecords")
   * 
   * @Produces({MediaType.APPLICATION_JSON}) public Response addExpelRecords(final JsonObject
