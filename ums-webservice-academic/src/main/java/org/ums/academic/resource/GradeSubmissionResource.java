...
public class GradeSubmissionResource extends MutableGradeSubmissionResource {
  ...
  public JsonObject getExamGrade(@Context HttpServletRequest pHttpServletRequest, final @Context Request pRequest,
  ...
  public JsonObject getGradeSubmissionStatus(@Context HttpServletRequest pHttpServletRequest,
      final @Context Request pRequest, final @PathParam("semester-id") Integer pSemesterId,
      final @PathParam("exam-type") Integer pExamTypeId, final @PathParam("program-id") Integer pProgramId,
      final @PathParam("year-semester") Integer pYearSemester, final @PathParam("dept-id") String pDeptId,
      final @PathParam("role") String pUserRole, final @PathParam("status") int pStatus) {
  ...
  public JsonObject getChartData(@Context HttpServletRequest pHttpServletRequest, final @Context Request pRequest,
      final @PathParam("semester-id") Integer pSemesterId, final @PathParam("course-id") String pCourseId,
  ...
  public JsonObject getGradeSubmissionDeadLine(@Context HttpServletRequest pHttpServletRequest,
      final @Context Request pRequest, final @PathParam("semester-id") Integer pSemesterId,
      final @PathParam("exam-type") Integer pExamType, final @PathParam("course-type") int pCourseType,
  ...
  public JsonObject getMarksLogs(@Context HttpServletRequest pHttpServletRequest, final @Context Request pRequest,
      final @PathParam("semester-id") Integer pSemesterId, final @PathParam("course-id") String pCourseId,
  ...
  public JsonObject getMarksSubmissionStat(@Context HttpServletRequest pHttpServletRequest,
      final @Context Request pRequest, final @PathParam("program-type") Integer programType,
      final @PathParam("semester-id") Integer pSemesterId, final @PathParam("dept-id") String pDeptId,
      final @PathParam("exam-type") Integer pExamType, final @PathParam("status") String pStatus) throws Exception {
