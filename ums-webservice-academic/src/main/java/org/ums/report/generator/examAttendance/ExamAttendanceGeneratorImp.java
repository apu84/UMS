...
class ExamAttendanceGeneratorImp implements ExamAttendanceGenerator {
  ...
  public void createTestimonial(Integer pSemesterId, Integer pExamType, String pExamDate, OutputStream pOutputStream)
    ...
    getHeader(pSemesterId, pExamType, pExamDate, document, fontTimes11Normal, fontTimes12Bold, fontTimes10Bold, fontTimes9Bold);
    if(programMap.size()>0){
      ...
      getFooter(document, fontTimes10Bold);
      document.close();
  ...
  public void getHeader(Integer pSemesterId, Integer pExamType, String pExamDate, Document document,
      Font fontTimes11Normal, Font fontTimes12Bold, Font fontTimes10Bold, Font fontTimes9Bold) throws DocumentException {
  ...
  public void getFooter(Document document, Font fontTimes10Bold) throws DocumentException {
    UmsCell cell;
