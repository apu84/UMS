 ...
 */
public class SubGroupCCIDaoDecorator extends ContentDaoDecorator<SubGroupCCI,MutableSubGroupCCI,Integer,SubGroupCCIManager> implements SubGroupCCIManager {
