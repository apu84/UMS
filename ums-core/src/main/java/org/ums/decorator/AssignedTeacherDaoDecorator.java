...
public class AssignedTeacherDaoDecorator<R, M, I, C extends AssignedTeacherManager<R, M, I>> extends
    ContentDaoDecorator<R, M, I, C> implements AssignedTeacherManager<R, M, I> {
