...
public class UmsUtils {
  ...
  public static Paragraph getIUMSHeaderParagraph() {
    ...
    Paragraph iumsHeaderParagraph =
        new Paragraph("Generated By IUMS on " + UmsUtils.formatDate(new Date(), "dd MMMM, yyyy") + " at "
            + dateFormat.format(new Date()), headerFont);
    iumsHeaderParagraph.setAlignment(Element.ALIGN_RIGHT);
    return iumsHeaderParagraph;
  }
