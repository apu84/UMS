...
import java.util.concurrent.atomic.AtomicReference;
  ...
  public List<OptionalCourseApplicationStatDto> getApplicationStatistics(int pSemesterId, int pProgramId,int pYear, int pSemester) throws Exception {
    ...
    public void batchInsertApplicationCourse(int pSemesterId, int pProgramId,int pYear, int pSemester,final List<Course> pCourseList){
      String sql = "Insert into OPT_COURSE_OFFER(SEMESTER_ID, PROGRAM_ID, YEAR, SEMESTER, COURSE_ID, CALL_FOR_APPLICATION, APPROVED, TOTAL_APPLIED) " +
          " Values(?, ?, ?, ?, ?,'Y', 'N', 0) ";
    ...
    public List<OptCourseStudentDto> getStudentList(int pSemesterId,String pCourseId, String pStatus) throws Exception {
      ...
      String query = "Select opt.*,std.full_name From OPT_COURSE_APPLICATION opt,STUDENTS std Where std.Student_Id in  " +
          ...
          "And opt.Semester_Id=?  and Course_Id=?";
    ...
    public List<OptCourseStudentDto> getNonAssignedSectionStudentList(int pSemesterId, int pProgramId,String pCourseId) throws Exception {
      String query = "Select * From ( " +
          ...
          "And OPT_COURSE.STUDENT_ID=students.student_id   AND COURSE_ID='"+pCourseId+"' "+
          ...
          "(WITH DATA AS " +
          "      ( SELECT STUDENT_LIST str FROM OPT_COURSE_SECTION_INFO WHERE SEMESTER_ID='11012017' AND PROGRAM_ID='110500' AND COURSE_ID='"+pCourseId+"' " +
          "      ) " +
    ...
    public OptCourseApplicationStatus getApplicationStatus(String pStudentId,int pSemesterId) throws Exception {
    ...
    public List<OptCourseStudentDto>  getAppliedCoursesByStudent(String pStudentId,int pSemesterId) throws Exception {
    ...
    public int updateCourseStatus(int pSemesterId, String pCourseId,final List<String> pStudentList,int pNewStatus) throws Exception {
      batchStatusUpdateForOptionalCourse(pSemesterId, pCourseId, pStudentList, pNewStatus);
      return 1;
    }

    public void batchStatusUpdateForOptionalCourse(int pSemesterId, String pCourseId,final List<String> pStudentList,int pNewStatus){
    ...
    public int updateCourseStatusForDependentCourse(int pSemesterId, String pCourseId,final List<String> pStudentList,int pNewStatus) throws Exception {
      batchStatusUpdateForOptionalCourseForDependentCourse(pSemesterId, pCourseId, pStudentList, pNewStatus);
      return 1;
    }

    public void batchStatusUpdateForOptionalCourseForDependentCourse(int pSemesterId, String pCourseId,final List<String> pStudentList,int pNewStatus){
      String sql = "Update OPT_COURSE_APPLICATION Set Status=? Where  " +
    ...
    public int deleteCourseAppliedByTeacher(int pSemesterId, String pCourseId,final List<String> pStudentList) throws Exception {
    ...
    public void batchDeleteCourseAppliedByTeacher(int pSemesterId, String pCourseId,final List<String> pStudentList){
      String sql = " Delete OPT_COURSE_APPLICATION Where Student_Id=? and Semester_Id=? and Course_Id=? and APPLICATION_TYPE=1";
      mJdbcTemplate .batchUpdate(sql, new BatchPreparedStatementSetter() {
    ...
    public int insertShiftApplication(int pSemesterId, String pCourseId,String pDependentCourseId,final List<String> pStudentList) throws Exception {
      batchInsertShiftApplication(pSemesterId, pCourseId, pDependentCourseId,pStudentList);
      return 1;
    }


    public void batchInsertShiftApplication(int pSemesterId, String pCourseId,String pDependentCourseId,final List<String> pStudentList){
      String sql = "Insert Into OPT_COURSE_APPLICATION(STUDENT_ID, SEMESTER_ID, COURSE_ID, APPLIED_ON, STATUS, APPLICATION_TYPE, DEPENDENT_COURSE_ID) " +
          "Values(?,?,?,sysdate,1,1,?) ";
    ...
    public int saveStudentApplication(String pStudentId,int pSemester,final List<String> pCourseList) throws Exception {
    ...
    public void batchMergeStudentApplication(String pStudentId,int pSemester,final List<String> pCourseList){
      String sql = "merge into OPT_COURSE_APPLICATION application1 " +
          "    using  " +
    ...
    public int updateStatus(String pStudentId,Integer pSemesterId,final OptCourseApplicationStatus status) throws Exception {
