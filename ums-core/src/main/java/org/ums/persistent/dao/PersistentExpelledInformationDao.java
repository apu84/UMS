...
public class PersistentExpelledInformationDao extends ExpelledInformationDaoDecorator {
  ...
  String INSERT_ALL =
      "Insert into DER_EXPELLED_INFO (ID,STUDENT_ID,SEMESTER_ID,COURSE_ID,EXAM_TYPE,REG_TYPE,EXPEL_REASON,EXAM_DATE) values (?,?,?,?,?,?,?,TO_DATE(?,'DD-MM-YYYY'))";
  ...
  String DELETE_ALL = "DELETE FROM DER_EXPELLED_INFO";
