...
import org.ums.decorator.SemesterSyllabusMapDaoDecorator;
...
public class PersistentSemesterSyllabusMapDao extends SemesterSyllabusMapDaoDecorator {
  ...
  static String SELECT_BY_SEMESTER_PROGRAM =
      "Select tmp1.*,dept.short_name,semester.semester_name Syllabus,SEMESTER.SEMESTER_ID syllabus_semester_id From ( "
