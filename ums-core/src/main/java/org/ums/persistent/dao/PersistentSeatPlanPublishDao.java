...
public class PersistentSeatPlanPublishDao extends SeatPlanPublishDaoDecorator{
  ...
  public int create(List<MutableSeatPlanPublish> pMutableList) throws Exception {
    String query = " insert into sp_publish(semester_id,exam_type,exam_date,published) values(?,?,to_date(?,'dd/MM/YYYY'),?)";
  ...
  public List<Object[]> getUpdateParamList(List<MutableSeatPlanPublish> pMutableSeatPlanPublishs) throws Exception{
  ...
  public List<Object[]> getInsertParamList(List<MutableSeatPlanPublish> pMutableSeatPlanPublishs) throws Exception{
    List<Object[]> params = new ArrayList<>();
    for(SeatPlanPublish publish: pMutableSeatPlanPublishs){
      params.add(new Object[]{
