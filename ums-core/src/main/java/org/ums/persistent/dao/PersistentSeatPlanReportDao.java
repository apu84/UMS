...
public class PersistentSeatPlanReportDao extends SeatPlanReportDaoDecorator {
  ...
  String SELECT_ALL_TOP_SHEET = "" + "SELECT  " + "  seatPlan.ROOM_NO,  "
      + "  examRoutine.PROGRAM_LONG_NAME,  " + "  examRoutine.COURSE_TITLE,  "
      + "  examRoutine.COURSE_NO,  " + "  to_char(examRoutine.EXAM_DATE,'dd-mm-YYYY') EXAM_DATE,  "
      + "  seatPlan.CURR_YEAR ,  " + "  seatPlan.CURR_SEMESTER,  " + "  seatPlan.STUDENT_ID  "
      + "FROM  " + "        (  " + "  " + "      SELECT  " + "        ROOM_INFO.ROOM_NO,  "
      + "        SEAT_PLAN.STUDENT_ID,  " + "        SEAT_PLAN.SEMESTER_ID,  "
      + "        STUDENTS.CURR_YEAR,  " + "        students.CURR_SEMESTER,  "
      + "        STUDENTS.PROGRAM_ID  " + "      FROM  " + "        SEAT_PLAN,  "
      + "        STUDENTS,  " + "        ROOM_INFO  " + "      WHERE  "
      + "          SEAT_PLAN.STUDENT_ID = STUDENTS.STUDENT_ID AND  "
      + "          SEAT_PLAN.SEMESTER_ID = ? AND  " + "          SEAT_PLAN.EXAM_TYPE = ? AND  "
      + "          SEAT_PLAN.ROOM_ID = ROOM_INFO.ROOM_ID  " + "      ORDER BY  "
      + "        ROOM_INFO.ROOM_ID, STUDENTS.STUDENT_ID  " + "        ) seatPlan,  " + "    (  "
      + "      select  " + "        EXAM_ROUTINE.EXAM_DATE,  "
      + "        MST_PROGRAM.PROGRAM_ID,  " + "        MST_PROGRAM.PROGRAM_LONG_NAME,  "
      + "        MST_COURSE.COURSE_NO,  " + "        MST_COURSE.COURSE_TITLE,  "
      ...
      + "        MST_COURSE.COURSE_NO  " + "      ) examRoutine  " + "WHERE  "
      + "  seatPlan.PROGRAM_ID=examRoutine.PROGRAM_ID AND  "
      + "  seatPlan.CURR_YEAR = examRoutine.YEAR AND  "
      + "  seatPlan.CURR_SEMESTER = examRoutine.SEMESTER  " + "ORDER BY  "
  ...
  String SELECT_ALL_ATTENDENCE_SHEET_EXAM_DATE = "" + "SELECT  " + "  seatPlan.ROOM_NO,  "
      + "  examRoutine.PROGRAM_SHORT_NAME,  " + "  examRoutine.COURSE_TITLE,  "
      + "  examRoutine.COURSE_NO,  " + "  to_char(examRoutine.EXAM_DATE,'dd-mm-YYYY') EXAM_DATE,  "
      + "  seatPlan.CURR_YEAR ,  " + "  seatPlan.CURR_SEMESTER,  " + "  seatPlan.STUDENT_ID  "
      + "FROM  " + "        (  " + "  " + "      SELECT  " + "        ROOM_INFO.ROOM_NO,  "
      + "        SEAT_PLAN.STUDENT_ID,  " + "        SEAT_PLAN.SEMESTER_ID,  "
      ...
      + "        ROOM_INFO.ROOM_ID, STUDENTS.STUDENT_ID  " + "        ) seatPlan,  " + "    (  "
      + "      select  " + "        EXAM_ROUTINE.EXAM_DATE,  "
      + "        MST_PROGRAM.PROGRAM_ID,  " + "        MST_PROGRAM.PROGRAM_SHORT_NAME,  "
      + "        MST_COURSE.COURSE_NO,  " + "        MST_COURSE.COURSE_TITLE,  "
      + "        MST_COURSE.YEAR,  " + "        MST_COURSE.SEMESTER  "
      + "      from EXAM_ROUTINE,  " + "        MST_PROGRAM,  " + "        MST_COURSE  "
      + "      where  " + "        EXAM_ROUTINE.EXAM_TYPE=?  "
  ...
  String SELECT_ALL_TOP_SHEET_EXAM_DATE = "" + "SELECT  " + "  seatPlan.ROOM_NO,  "
      + "  examRoutine.PROGRAM_LONG_NAME,  " + "  examRoutine.COURSE_TITLE,  "
      + "  examRoutine.COURSE_NO,  " + "  to_char(examRoutine.EXAM_DATE,'dd-mm-YYYY') EXAM_DATE,  "
      + "  seatPlan.CURR_YEAR ,  " + "  seatPlan.CURR_SEMESTER,  " + "  seatPlan.STUDENT_ID  "
      + "FROM  " + "        (  " + "  " + "      SELECT  " + "        ROOM_INFO.ROOM_NO,  "
