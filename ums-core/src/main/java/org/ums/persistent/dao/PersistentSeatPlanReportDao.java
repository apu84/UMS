...
public class PersistentSeatPlanReportDao extends SeatPlanReportDaoDecorator {
  ...
  String SELECT_ALL_ATTENDENCE_SHEET_CCI =
      "SELECT  "
          ...
          + "ORDER BY  "
          + "  seatPlan.ROOM_NO, seatPlan.PROGRAM_ID, examRoutine.EXAM_DATE, examRoutine.COURSE_NO, examRoutine.YEAR, examRoutine.SEMESTER, to_number(seatPlan.STUDENT_ID);";
  ...
  String SELECT_ALL_TOP_SHEET_EXAM_DATE_CCI =
      "SELECT  "
          + "  seatPlan.ROOM_NO,  "
          + "  examRoutine.PROGRAM_LONG_NAME,  "
          + "  examRoutine.COURSE_TITLE,  "
          ...
          + "      UG_REGISTRATION_RESULT.EXAM_TYPE = examRoutine.EXAM_TYPE  "
          + "ORDER BY  "
          + "  seatPlan.PROGRAM_ID, examRoutine.COURSE_NO, examRoutine.YEAR, examRoutine.SEMESTER, to_number(seatPlan.STUDENT_ID)";
