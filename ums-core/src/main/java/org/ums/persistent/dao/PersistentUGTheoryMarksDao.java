...
public class PersistentUGTheoryMarksDao extends UGTheoryMarksDaoDecorator {
  ...
  private List<Object[]> getInsertParamList(List<MutableUGTheoryMarks> pTheoryMarkses) throws Exception {
  ...
  private List<Object[]> getDeleteParamList(List<MutableUGTheoryMarks> pTheoryMarkses) throws Exception {
    List<Object[]> params = new ArrayList<>();
    for (UGTheoryMarks theoryMarks : pTheoryMarkses) {
      params.add(new Object[]{
          theoryMarks.getStudent().getId(),
