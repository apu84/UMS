...
public class PersistentRoutineDao extends RoutineDaoDecorator {
  ...
  static String UPDATE_ONE = "UPDATE CLASS_ROUTINE SET SEMESTER_ID = ?,PROGRAM_ID, COURSE_ID= ?,DAY=?, SECTION=?, YEAR=?, SEMESTER=?, START_TIME=?,DURATION=?,ROOM_NO=? END_TIME=?, LAST_MODIFIED="+ getLastModifiedSql()+"";
