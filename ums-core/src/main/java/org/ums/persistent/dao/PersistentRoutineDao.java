...
public class PersistentRoutineDao extends RoutineDaoDecorator {
  static String SELECT_ALL="SELECT ROUTINE_ID,SEMESTER_ID,PROGRAM_ID,COURSE_ID,DAY,SECTION,YEAR,SEMESTER,START_TIME,END_TIME,DURATION,ROOM_NO,LAST_MODIFIED FROM ROUTINE ";
  static String UPDATE_ONE = "UPDATE ROUTINE SET SEMESTER_ID = ?,PROGRAM_ID, COURSE_ID= ?,DAY=?, SECTION=?, YEAR=?, SEMESTER=?, START_TIME=?,DURATION=?,ROOM_NO=? END_TIME=?, LAST_MODIFIED="+ getLastModifiedSql()+"";
  static String DELETE_ONE = "DELETE FROM ROUTINE ";
  static String INSERT_ONE = "INSERT INTO ROUTINE(SEMESTER_ID,PROGRAM_ID,COURSE_ID,DAY,SECTION,YEAR,SEMESTER,START_TIME,END_TIME,DURATION,ROOM_NO,LAST_MODIFIED) "+
      "VALUES(?,?,?,?,?,?,?,?,?,?,?,"+getLastModifiedSql()+")";
  static String ORDER_BY = "ORDER BY SEMESTER_ID";
  static String SELECT_ALL_FOR_TEACHER = "SELECT SEMESTER_ID,PROGRAM_ID,COURSE_ID,DAY,SECTION,YEAR,SEMESTER,START_TIME,END_TIME,DURATION,ROOM_NO FROM ROUTINE AND COURSE_TEACHER WHERE "+
      "WHERE COURSE_TEACHER.TEACHER_ID = ? AND ROUTINE.COURSE_ID = COURSE_TEACHER.COURSE_ID";
  static String SELECT_ALL_FOR_STUDENT = " SELECT ROUTINE_ID,SEMESTER_ID,PROGRAM_ID,COURSE_ID,DAY,SECTION,YEAR,SEMESTER,START_TIME,END_TIME,DURATION,ROOM_NO,LAST_MODIFIED FROM ROUTINE WHERE SEMESTER_ID=? AND PROGRAM_ID=?";

  static String SELECT_ALL_FOR_EMPLOYEE = "SELECT ROUTINE_ID,SEMESTER_ID,PROGRAM_ID,COURSE_ID,DAY,SECTION,YEAR,SEMESTER,START_TIME,END_TIME,DURATION,ROOM_NO,LAST_MODIFIED FROM ROUTINE WHERE SEMESTER_ID=? and PROGRAM_ID=? and YEAR=? and SEMESTER=? ";
