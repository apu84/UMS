...
public class PersistentPersonalInformationDao extends PersonalInformationDaoDecorator {
  ...
  static String INSERT_ONE =
      "INSERT INTO EMP_PERSONAL_INFO (EMPLOYEE_ID, SALUTATION, NAME, GENDER, BLOOD_GROUP, FATHER_NAME, MOTHER_NAME,"
  ...
  static String GET_ONE =
      "SELECT EMPLOYEE_ID, SALUTATION, NAME, GENDER, BLOOD_GROUP, FATHER_NAME, MOTHER_NAME, NATIONALITY, RELIGION, "
  ...
  public String create(MutablePersonalInformation pMutablePersonalInformation) {
    ...
    mJdbcTemplate.update(query, pMutablePersonalInformation.getId(), pMutablePersonalInformation.getSalutationId(),
        pMutablePersonalInformation.getName(), pMutablePersonalInformation.getGender(),
  ...
  public int update(MutablePersonalInformation pMutablePersonalInformation) {
    ...
    return mJdbcTemplate.update(
        query,
        pMutablePersonalInformation.getSalutationId(),
  ...
  class PersonalInformationRowMapper implements RowMapper<PersonalInformation> {
    ...
    public PersonalInformation mapRow(ResultSet resultSet, int i) throws SQLException {
      ...
      personalInformation.setSalutationId(resultSet.getInt("SALUTATION"));
