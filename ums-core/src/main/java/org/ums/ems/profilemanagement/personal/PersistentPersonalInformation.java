...
public class PersistentPersonalInformation implements MutablePersonalInformation {
  ...
  private String mId;
  private Integer mSalutationId;
  private Salutation mSalutation;
  ...
  public PersistentPersonalInformation(PersistentPersonalInformation pPersistentPersonalInformation) {
    ...
    mSalutationId = pPersistentPersonalInformation.getSalutationId();
    mSalutation = pPersistentPersonalInformation.getSalutation();
  ...
  @Override
  public void setSalutationId(Integer pSalutationId) {
    mSalutationId = pSalutationId;
  }

  @Override
  public void setSalutation(Salutation pSalutation) {
  ...
  public String getFullName() {
    return Salutation.get(mSalutationId).getLabel().concat(" ").concat(mName);
  }
