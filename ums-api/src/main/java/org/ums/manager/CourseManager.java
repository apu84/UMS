...
public interface CourseManager extends ContentManager<Course, MutableCourse, String> {
  ...
  public List<Course> getMandatoryCourses(final String pSyllabusId, final Integer pYear, final Integer pSemester);

  public List<Course> getMandatoryTheoryCourses(final String pSyllabusId, final Integer pYear, final Integer pSemester);
