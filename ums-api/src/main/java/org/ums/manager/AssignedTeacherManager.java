...
public interface AssignedTeacherManager<R, M, I> extends ContentManager<R, M, I> {
  ...
  List<R> getAssignedTeachers(final Integer pProgramId, final Integer pSemesterId, final Integer pYear, String pOfferedBy);
  ...
  List<R> getAssignedTeachers(final Integer pProgramId, final Integer pSemesterId, final String pCourseId, String pOfferedBy);
