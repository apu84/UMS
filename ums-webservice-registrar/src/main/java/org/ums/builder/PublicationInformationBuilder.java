...
public class PublicationInformationBuilder implements Builder<PublicationInformation, MutablePublicationInformation> {
  ...
  public void build(JsonObjectBuilder pBuilder, PublicationInformation pReadOnly, UriInfo pUriInfo,
    ...
    pBuilder.add("publicationTypeId", pReadOnly.getTypeId());
    ...
    pBuilder.add("publicationCountryId", pReadOnly.getCountryId() == 0 ? null : pReadOnly.getCountryId());
  ...
  public void build(MutablePublicationInformation pMutable, JsonObject pJsonObject, LocalCache pLocalCache) {
    ...
    pMutable.setCountry(pJsonObject.containsKey("publicationCountry") ? pJsonObject.getJsonObject("publicationCountry") == null ? null : mCountryManager.get(pJsonObject.getJsonObject(
        "publicationCountry").getInt("id")) : null);
    ...
    pMutable.setType(mPublicationType.get(pJsonObject.getJsonObject("publicationType").getInt("id")));
