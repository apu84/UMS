module ums{
  ...
  export class ClassRoutineService{
    ...
    public getAllTeacherWiseReport(semesterId: number, programId: number){
      this.httpClient.get(`${this.routineUrl}/teacher-wise-report/semester/${semesterId}/program/${programId}`, 'application/pdf',
          (data:any, etag: string)=>{
            var file = new Blob([data], {type: 'application/pdf'});
            UmsUtil.writeFileContent(data, 'application/pdf', 'TeacherWiseRoutine');
            //this.$window.open(fileURL);
    ...
    public getAllRoomWiseRoutine(semesterId: number, programId: number){
      this.httpClient.get(`${this.routineUrl}/room-wise-report/semester/${semesterId}/program/${programId}`, 'application/pdf',
          (data:any, etag: string)=>{
            var file = new Blob([data], {type: 'application/pdf'});
            UmsUtil.writeFileContent(data, 'application/pdf', 'RoomWiseRoutine');
            //this.$window.open(fileURL);
