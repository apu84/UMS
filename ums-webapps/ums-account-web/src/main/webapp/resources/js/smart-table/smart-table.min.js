...
!function (t, e) {
    ...
    t.module("smart-table", []).run(["$templateCache", function (t) {
        ...
        var o, u, p, g = r.stTable, d = n(g), f = d.assign, m = s("orderBy"), h = s("filter"), b = i(d(a)),
            v = {sort: {}, search: {}, pagination: {start: 0, totalItemCount: 0}}, S = !0, P = this;
        ...
        return {
            require: "^stTable", link: function (s, r, i, c) {
                var l = c, o = null, u = i.stDelay || e.search.delay, p = i.stInputEvent || e.search.inputEvent,
        ...
        return {
            restrict: "A", require: "^stTable", link: function (r, i, c, l) {
                ...
                var u, p = c.stSort, g = n(p), d = 0, f = c.stClassAscent || a.sort.ascentClass,
                    m = c.stClassDescent || a.sort.descentClass, h = [f, m],
                    b = c.stSkipNatural !== e ? c.stSkipNatural : a.sort.skipNatural,
                    v = c.stDescendingFirst !== e ? c.stDescendingFirst : a.sort.descendingFirst, S = null,
                    P = c.stDelay || a.sort.delay, y = "aria-sort";
