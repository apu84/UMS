...
!function () {
    ...
    angular.module("ui.grid").service("uiGridColumnMenuService", ["i18nService", "uiGridConstants", "gridUtil", function (a, b, c) {
        var d = {
            initialize: function (a, b) {
                ...
                return [{
                    title: function () {
                        return a.getSafeText("sort.ascending")
                    }, icon: "ui-grid-icon-sort-alt-up", action: function (a) {
                    ...
                    title: function () {
                        return a.getSafeText("sort.descending")
                    }, icon: "ui-grid-icon-sort-alt-down", action: function (a) {
                    ...
                    title: function () {
                        return a.getSafeText("sort.remove")
                    ...
                    title: function () {
                        return a.getSafeText("column.hide")
                    }, icon: "ui-grid-icon-cancel", shown: function () {
                        return d.hideable(c)
                    }, action: function (a) {
                    ...
                    pre: function (b, c, d, e) {
                        b.col.updateFilters = function (d) {
                            if (c.children().remove(), d) {
                                ...
                                void 0 === e && "" !== b.col.providedFilterHeaderTemplate ? b.col.filterHeaderTemplatePromise && b.col.filterHeaderTemplatePromise.then(function () {
                                    e = b.col.filterHeaderTemplate, c.append(a(e)(b))
                                }) : c.append(a(e)(b))
                            }
            ...
            compile: function (a, b, e) {
                return {
                    pre: function (a, b, c, e) {
                        var f = a.col.footerCellTemplate;
                        void 0 === f && "" !== a.col.providedFooterCellTemplate ? a.col.footerCellTemplatePromise && a.col.footerCellTemplatePromise.then(function () {
                            f = a.col.footerCellTemplate, b.append(d(f)(a))
                        }) : b.append(d(f)(a))
    ...
    angular.module("ui.grid").directive("uiGridHeaderCell", ["$compile", "$timeout", "$window", "$document", "gridUtil", "uiGridConstants", "ScrollEvent", "i18nService", function (a, b, c, d, e, f, g, h) {
        var i = 500, j = 500, k = {
            ...
            compile: function () {
                return {
                    pre: function (b, c, d) {
                        var e = b.col.headerCellTemplate;
                        void 0 === e && "" !== b.col.providedHeaderCellTemplate ? b.col.headerCellTemplatePromise && b.col.headerCellTemplatePromise.then(function () {
                            e = b.col.headerCellTemplate, c.append(a(e)(b))
                        }) : c.append(a(e)(b))
                        ...
                        }, a.headerCellArrowKeyDown = function (b) {
                            (32 === b.keyCode || 13 === b.keyCode) && (b.preventDefault(), a.toggleMenu(b))
                ...
                return {
                    pre: function (c, d) {
                        ...
                        ("undefined" == typeof b.shown || null === b.shown) && (b.shown = function () {
                            ...
                            var a = b.name;
                            return "function" == typeof b.name && (a = b.name.call()), a
                        }, b.i18n = c.get()
                    }
                }
            }
            ...
            compile: function () {
                return {
                    pre: function (a, b, c, d) {
                        ...
                        if (!a.rowContainerName) throw new Error("No row render container name specified");
                        if (!a.colContainerName) throw new Error("No column render container name specified");
                        if (!g.renderContainers[a.rowContainerName]) throw new Error("Row render container '" + a.rowContainerName + "' is not registered.");
                        if (!g.renderContainers[a.colContainerName]) throw new Error("Column render container '" + a.colContainerName + "' is not registered.");
                    ...
                    post: function (d, e, f, g) {
                        ...
                        function k() {
                            var a = m.options.minRowsToShow * m.options.rowHeight,
                                f = m.options.showHeader ? m.options.headerRowHeight : 0, g = m.calcFooterHeight(),
                                h = 0;
    ...
    angular.module("ui.grid").factory("Grid", ["$q", "$compile", "$parse", "gridUtil", "uiGridConstants", "GridOptions", "GridColumn", "GridRow", "GridApi", "rowSorter", "rowSearcher", "GridRenderContainer", "$timeout", "ScrollEvent", function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
        ...
        p.prototype.calcFooterHeight = function () {
            ...
            var c = this, d = c.rows.slice(0), e = c.rowHashMap || c.createRowHashMap(), f = !0;
            c.rowHashMap = c.createRowHashMap(), c.rows.length = 0, b.forEach(function (a, b) {
                var g, i;
                i = c.options.enableRowHashing ? e.get(a) : c.getRow(a, d), i && (g = i, g.entity = a), g || (g = c.processRowBuilders(new h(a, b, c))), c.rows.push(g), c.rowHashMap.put(a, g), g.isSelected || (f = !1)
            }), c.selection && (c.selection.selectAll = f), c.assignTypes();
            var g = a.when(c.processRowsProcessors(c.rows)).then(function (a) {
                return c.setVisibleRows(a)
            })["catch"](angular.noop), i = a.when(c.processColumnsProcessors(c.columns)).then(function (a) {
            ...
            if (!b.cellDisplayGetterCache) {
                ...
                if ("undefined" != typeof a.entity["$$" + b.uid]) b.cellDisplayGetterCache = c(a.entity["$$" + b.uid].rendered + d); else if (this.options.flatEntityAccess && "undefined" != typeof b.field) {
                    var e = b.field.replace(/(')|(\\)/g, "\\$&");
                    b.cellDisplayGetterCache = c("entity['" + e + "']" + d)
                } else b.cellDisplayGetterCache = c(a.getEntityQualifiedColField(b) + d)
            }
            var f = angular.extend({}, a, {col: b});
            return b.cellDisplayGetterCache(f)
        ...
        return p.prototype.renderingComplete = function () {
            ...
            for (var g in c.renderContainers) if (c.renderContainers.hasOwnProperty(g)) {
                ...
                (h.header || h.headerCanvas) && (h.explicitHeaderHeight = null, h.explicitHeaderCanvasHeight = null, f.push(h))
            }
            return b && c.buildStyles(), m(f.length > 0 ? function () {
                ...
                for (a = 0; a < f.length; a++) if (g = f[a], null !== g.canvasWidth && !isNaN(g.canvasWidth)) {
                    if (g.header) {
                        var l = g.headerHeight = k(g.headerHeight, d.outerElementHeight(g.header)),
            ...
            if (null !== b) {
                ...
                o = 0 > o ? 0 : o;
                var p, q;
                h > o ? (p = d.renderContainers.body.prevScrollTop - (h - o), q = p / m, 1 >= q && (e.y = {percentage: q})) : o > j && (p = o - j + d.renderContainers.body.prevScrollTop, q = p / m, 1 >= q && (e.y = {percentage: q}))
            }
            if (null !== c) {
                ...
                i > t ? (x = d.renderContainers.body.prevScrollLeft - (i - t),
                    y = x / s, y = y > 1 ? 1 : y, e.x = {percentage: y}) : w > k && (x = w - k + d.renderContainers.body.prevScrollLeft, y = x / s, y = y > 1 ? 1 : y, e.x = {percentage: y})
            }
            var z = a.defer();
            if (e.y || e.x) {
    ...
    angular.module("ui.grid").factory("GridColumn", ["gridUtil", "uiGridConstants", "i18nService", function (a, b, c) {
        ...
        return d.prototype.hideColumn = function () {
            ...
            var a = this.sort.priority;
            this.grid.columns.forEach(function (b) {
                b.sort && void 0 !== b.sort.priority && b.sort.priority > a && (b.sort.priority -= 1)
    ...
    angular.module("ui.grid").factory("GridRenderContainer", ["gridUtil", "uiGridConstants", function (a, b) {
        ...
        return c.prototype.reset = function () {
            ...
            var b = this, c = [], d = 0, e = 0, f = "", g = !1, h = [], i = [], j = 0,
                k = b.grid.getViewportWidth() - b.grid.scrollbarWidth, l = [];
            angular.forEach(b.grid.renderContainers, function (a, b) {
                l = l.concat(a.visibleColumnCache)
            }), l.forEach(function (f, l) {
                var m = 0;
                if (f.visible) if (g && (k += b.grid.scrollbarWidth), !g && f.colDef.pinnedRight && (g = !0), angular.isNumber(f.width)) m = parseInt(f.width, 10), e += m, f.drawnWidth = m, h.push(f); else if (a.endsWith(f.width, "%")) {
                    var n = parseInt(f.width.replace(/%/g, ""), 10);
                    m = parseInt(n / 100 * k), m > f.maxWidth && (m = f.maxWidth), m < f.minWidth && (m = f.minWidth), e += m, f.drawnWidth = m, j += n, i.push(f)
                } else angular.isString(f.width) && -1 !== f.width.indexOf("*") && (d += f.width.length, c.push(f))
            });
            var m = k - e;
            if (c.length > 0) {
                var n = m / d;
                c.forEach(function (a) {
                    var b = parseInt(a.width.length * n, 10);
                    b > a.maxWidth && (b = a.maxWidth), b < a.minWidth && (b = a.minWidth), e += b, a.drawnWidth = b
                })
            }
            var o;
            if (c.length > 0 ? o = c : i.length > 0 && 0 === h.length && 100 === j && (o = i), !angular.isUndefined(o)) {
                for (var p = function (a) {
                    a.drawnWidth < a.maxWidth && q > 0 && (a.drawnWidth++, e++, q--, r = !0)
                }, q = k - e, r = !0; q > 0 && r;) r = !1, o.forEach(p);
                var s = function (a) {
                    a.drawnWidth > a.minWidth && t > 0 && (a.drawnWidth--, e--, t--, r = !0)
                }, t = e - k;
                for (r = !0; t > 0 && r;) r = !1, o.forEach(s)
            }
            var u = 0;
            b.visibleColumnCache.forEach(function (a) {
                a.visible && (u += a.drawnWidth)
            }), l.forEach(function (a) {
                f += a.getColClassDefinition()
            }), b.canvasWidth = u, this.columnStyles = f
        ...
        var i = {
            createGrid: function (d) {
                ...
                var g = [], h = function (b, f, h, i, j) {
                    c[b] ? d[f] = c[b] : d[f] = h;
                    var k = a.getTemplate(d[f]).then(function (a) {
    ...
    angular.module("ui.grid").config(["$provide", function (a) {
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("de", {
                ...
                search: {
                    aria: {selected: "Zeile markiert", notSelected: "Zeile nicht markiert"},
                    placeholder: "Suche...",
                ...
                pagination: {
                    aria: {
                        ...
                        pageToLast: "Zum Ende"
                    }, sizes: "Einträge pro Seite", totalItems: "Einträgen", through: "bis", of: "von"
                },
                grouping: {
                    group: "Gruppieren",
    ...
    angular.module("ui.grid").config(["$provide", function (a) {
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("en", {
                ...
                search: {
                    aria: {selected: "Row selected", notSelected: "Row not selected"},
                    placeholder: "Search...",
        ...
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("fi", {
                ...
                pinning: {
                    ...
                    pinRight: "Lukitse oikealle", unpin: "Poista lukitus"
                },
                gridMenu: {
                    columns: "Sarakkeet:",
    ...
    angular.module("ui.grid").config(["$provide", function (a) {
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("pl", {
                ...
                search: {
                    aria: {selected: "Wiersz zaznaczony", notSelected: "Wiersz niezaznaczony"},
                    placeholder: "Szukaj...",
        ...
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("ru", {
                ...
                pagination: {
                    ...
                    totalItems: "строк", through: "по", of: "из"
                },
                grouping: {
                    group: "Группировать",
    ...
    a.directive("uiGridAutoResize", ["gridUtil", function (a) {
        return {
            require: "uiGrid", scope: !1, link: function (b, c, d, e) {
                var f = null, g = function (a, b) {
                    null !== f && clearTimeout(f), f = setTimeout(function () {
                        e.grid.gridWidth = a, e.grid.gridHeight = b, e.grid.refresh(), f = null
                    }, 400)
                };
                b.$watchGroup([function () {
                    return a.elementWidth(c)
                }, function () {
                    return a.elementHeight(c)
                }], function (a, b, c) {
                    angular.equals(a, b) || g(a[0], a[1])
                })
            }
        }
    }])
    ...
    a.constant("uiGridCellNavConstants", {
        ...
        return h
    }]), a.directive("uiGridCellnav", ["gridUtil", "uiGridCellNavService", "uiGridCellNavConstants", "uiGridConstants", "GridRowColumn", "$timeout", "$compile", "i18nService", function (a, b, c, d, e, f, g, h) {
        return {
                ...
                return {
                    pre: function (a, f, g, h) {
                        ...
                        b.initializeGrid(j), h.cellNav = {}, h.cellNav.makeRowCol = function (a) {
                            ...
                            if (null === j.cellNav.lastRowCol || -1 === g || j.cellNav.lastRowCol.col === f && j.cellNav.lastRowCol.row === d) {
                                var i = new e(d, f);
                                (null === j.cellNav.lastRowCol || j.cellNav.lastRowCol.row !== i.row || j.cellNav.lastRowCol.col !== i.col || j.options.enableCellEditOnFocus) && (j.api.cellNav.raise.navigate(i, j.cellNav.lastRowCol, c), j.cellNav.lastRowCol = i), h.grid.options.modifierKeysToMultiSelectCells && b ? j.cellNav.focusedCells.push(a) : j.cellNav.focusedCells = [a]
                        ...
                        function f() {
                            var d = '<div id="' + i.id + '-aria-speakable" class="ui-grid-a11y-ariascreenreader-speakable ui-grid-offscreen" aria-live="assertive" role="alert" aria-atomic="true" aria-hidden="false" aria-relevant="additions" >&nbsp;</div>',
                                e = g(d)(a);
                            b.prepend(e), a.$on(c.CELL_NAV_EVENT, function (a, b, c, d) {
                                function f(a) {
                                    a !== e.text().trim() && (e[0].style.clip = "rect(0px,0px,0px,0px)", e[0].innerHTML = "", e[0].style.visibility = "hidden", e[0].style.visibility = "visible", "" !== a && (e[0].style.clip = "auto", e[0].appendChild(document.createTextNode(a + " ")), e[0].style.visibility = "hidden", e[0].style.visibility = "visible"))
                                }

                                function g(a) {
                                    return ", " + h.getSafeText("headerCell.aria.column") + " " + a.displayName
                                }

                                function j(a) {
                                    return "selectionRowHeaderCol" === a.col.field ? a.row.isSelected ? h.getSafeText("search.aria.selected") : h.getSafeText("search.aria.notSelected") : i.getCellDisplayValue(a.row, a.col)
                                }

                                if (!d || "focus" !== d.type) {
                                    for (var k = [], l = i.api.cellNav.getCurrentSelection(), m = 0; m < l.length; m++) {
                                        var n = j(l[m]) + g(l[m].col);
                                        k.push(n)
                                    }
                                    var o = k.toString();
                                    f(o)
                        ...
                        if (j.grid.api.cellNav) {
                            ...
                            if (e.decorateRenderContainers(n), "body" === m) {
                                ...
                                o.on("keydown", function (a) {
                                    ...
                                    null === d && (j.grid.api.cellNav.raise.viewPortKeyDown(a, b, j.cellNav.handleKeyDown), p = b)
    ...
    a.constant("uiGridEditConstants", {
        ...
        return {
            priority: -100, restrict: "A", scope: !1, require: "?^uiGrid", link: function (b, l, m, n) {
                function o() {
                    l.on("dblclick", u),
                        l.on("touchstart", p), n && n.grid.api.cellNav && (G = n.grid.api.cellNav.on.viewPortKeyDown(b, function (a, c) {
                        null !== c && (c.row !== b.row || c.col !== b.col || b.col.colDef.enableCellEditOnFocus || s(a))
                    }), F = n.grid.api.cellNav.on.navigate(b, function (a, d, e) {
                        b.col.colDef.enableCellEditOnFocus && (a.row !== b.row || a.col !== b.col || !e || "click" !== e.type && "keydown" !== e.type || c(function () {
                            u(e)
                        }))
                ...
                function t(a, c, d) {
                    return !c.isSaving && (angular.isFunction(a.colDef.cellEditableCondition) ? a.colDef.cellEditableCondition(b, d) : a.colDef.cellEditableCondition)
                }
                    ...
                    pre: function (a, b, c) {
                        ...
                        h[0] && (i = h[0]), h[1] && (j = h[1]), h[2] && (k = h[2]), a.$on(c.events.BEGIN_CELL_EDIT, function (b, c) {
                            if (d(function () {
                                ...
                                if (e.isStartEditKey(a)) {
                                    var c = "number" == typeof a.which ? a.which : a.keyCode;
                                    c > 0 && (k.$setViewValue(String.fromCharCode(c), a), k.$render())
                                }
                                g()
                            });
        ...
        var c = {
            initializeGrid: function (b) {
                ...
                a.renderContainers.body.visibleRowCache.forEach(function (b) {
                    b.isExpanded || b.entity.subGridOptions && b.entity.subGridOptions.disableRowExpandable || c.toggleRowExpansion(a, b)
        ...
        var g = {
            delay: 100, initializeGrid: function (a) {
                ...
                a.exporterSuppressMenu = a.exporterSuppressMenu === !0, a.exporterMenuLabel = a.exporterMenuLabel ? a.exporterMenuLabel : "Export", a.exporterSuppressColumns = a.exporterSuppressColumns ? a.exporterSuppressColumns : [], a.exporterCsvColumnSeparator = a.exporterCsvColumnSeparator ? a.exporterCsvColumnSeparator : ",", a.exporterCsvFilename = a.exporterCsvFilename ? a.exporterCsvFilename : "download.csv", a.exporterPdfFilename = a.exporterPdfFilename ? a.exporterPdfFilename : "download.pdf", a.exporterOlderExcelCompatibility = a.exporterOlderExcelCompatibility === !0, a.exporterIsExcelCompatible = a.exporterIsExcelCompatible === !0, a.exporterMenuItemOrder = a.exporterMenuItemOrder ? a.exporterMenuItemOrder : 200, a.exporterPdfDefaultStyle = a.exporterPdfDefaultStyle ? a.exporterPdfDefaultStyle : {fontSize: 11}, a.exporterPdfTableStyle = a.exporterPdfTableStyle ? a.exporterPdfTableStyle : {margin: [0, 5, 0, 15]}, a.exporterPdfTableHeaderStyle = a.exporterPdfTableHeaderStyle ? a.exporterPdfTableHeaderStyle : {
                    ...
                    return d
                }, a.exporterFieldFormatCallback = a.exporterFieldFormatCallback ? a.exporterFieldFormatCallback : function (a, b, c, d) {
                    return null
                }, a.exporterFieldApplyFilters = a.exporterFieldApplyFilters === !0, a.exporterAllDataFn = a.exporterAllDataFn ? a.exporterAllDataFn : null, null === a.exporterAllDataFn && a.exporterAllDataPromise && (a.exporterAllDataFn = a.exporterAllDataPromise)
                ...
                a.api.core.addToGridMenu(a, [{
                    ...
                    title: f.getSafeText("gridMenu.exporterAllAsExcel"), action: function (c) {
                        a.api.exporter.excelExport(b.ALL, b.ALL)
                    }, shown: function () {
                        return a.options.exporterMenuExcel && a.options.exporterMenuAllData
                    }, order: a.options.exporterMenuItemOrder + 6
                }, {
                    title: f.getSafeText("gridMenu.exporterVisibleAsExcel"), action: function (c) {
                        a.api.exporter.excelExport(b.VISIBLE, b.VISIBLE)
                    }, shown: function () {
                        return a.options.exporterMenuExcel && a.options.exporterMenuVisibleData
                    }, order: a.options.exporterMenuItemOrder + 7
                }, {
                    title: f.getSafeText("gridMenu.exporterSelectedAsExcel"), action: function (c) {
                        a.api.exporter.excelExport(b.SELECTED, b.VISIBLE)
                    }, shown: function () {
                        return a.options.exporterMenuExcel && a.options.exporterMenuSelectedData && a.api.selection && a.api.selection.getSelectedRows().length > 0
                    }, order: a.options.exporterMenuItemOrder + 8
                }])
                ...
                if (d === b.ALL && c.rows.length !== c.options.totalItems && c.options.exporterAllDataFn) return c.options.exporterAllDataFn().then(function (a) {
                    c.modifyRows(a)
                });
                var f = a.defer();
                ...
                return d.forEach(function (b, c) {
                    if (b.colDef.exporterSuppressExport !== !0 && "$$hashKey" !== b.field && -1 === a.options.exporterSuppressColumns.indexOf(b.name)) {
                        var d = {
                            name: b.field,
                            ...
                            align: b.colDef.align ? b.colDef.align : "number" === b.colDef.type ? "right" : "left"
                        };
                        e.push(d)
                    }
                }), e
            }, getRowsFromNode: function (a) {
                for (var b = [], c = 0; c < a.children.length; c++) if (a.children[c].children && 0 === a.children[c].children.length) b.push(a.children[c]); else {
                    var d = this.getRowsFromNode(a.children[c]);
                    b = b.concat(d)
                }
                return b
            }, getDataSorted: function (a, b, c, d) {
                if (!a.treeBase || 0 === a.treeBase.numberLevels) return a.rows;
                for (var e = [], f = 0; f < a.treeBase.tree.length; f++) for (var g = this.getRowsFromNode(a.treeBase.tree[f]), h = 0; h < g.length; h++) e.push(g[h].row);
                return e
            }, getData: function (a, d, e, f) {
                var g, h, i = [];
                switch (d) {
                    case b.ALL:
                        g = this.getDataSorted(a, d, e, f);
                        break;
                    case b.VISIBLE:
                        g = a.getVisibleRows();
                        break;
                ...
                return g.forEach(function (c, d) {
                    if (c.exporterEnableExporting !== !1) {
                        ...
                        h.forEach(function (d, h) {
                            if ((d.visible || e === b.ALL) && d.colDef.exporterSuppressExport !== !0 && "$$hashKey" !== d.field && -1 === a.options.exporterSuppressColumns.indexOf(d.name)) {
                                var i = f ? a.getCellDisplayValue(c, d) : a.getCellValue(c, d),
                                    j = {value: a.options.exporterFieldCallback(a, c, d, i)},
                                    k = a.options.exporterFieldFormatCallback(a, c, d, i);
                                k && Object.assign(j, k), d.colDef.exporterPdfAlign && (j.alignment = d.colDef.exporterPdfAlign), g.push(j)
                            }
                        }), i.push(g)
                    }
                }), i
                ...
                for (var f = a.map(function (a) {
                    ...
                    var k = e.styles && e.styles[j] ? {style: e.styles[j].id} : null;
                    h.push({value: f[i].value, metadata: k})
                }
                g.push(h);
                for (var l = b.map(this.formatRowAsExcel(this, c, d)), m = 0; m < l.length; m++) g.push(l[m]);
                return g
            }, formatRowAsExcel: function (a, b, c) {
                return function (d) {
                    for (var e = [], f = 0; f < d.length; f++) {
                        var g = a.formatFieldAsExcel(d[f], b, c);
                        e.push({value: g, metadata: d[f].metadata})
                    }
                    return e
                }
            }, formatFieldAsExcel: function (a, b, c, d) {
                return null == a.value ? "" : "number" == typeof a.value ? a.value : "boolean" == typeof a.value ? a.value ? "TRUE" : "FALSE" : "string" == typeof a.value ? a.value.replace(/"/g, '""') : JSON.stringify(a.value)
            }, prepareAsExcel: function (a, b, c) {
                var d = {styles: {}};
                if (a.options.exporterExcelCustomFormatters && (d = a.options.exporterExcelCustomFormatters(a, b, d)), a.options.exporterExcelHeader) {
                    if (angular.isFunction(a.options.exporterExcelHeader)) a.options.exporterExcelHeader(a, b, c, d); else {
                        var e = a.options.exporterExcelHeader.text, f = a.options.exporterExcelHeader.style;
                        c.data.push([{value: e, metadata: {style: d.styles[f].id}}])
                    }
                }
                return d
            }, excelExport: function (a, b, c) {
                var d = this;
                this.loadAllDataIfNeeded(a, b, c).then(function () {
                    var e = a.options.showHeader ? d.getColumnHeaders(a, c) : [], f = new ExcelBuilder.Workbook,
                        g = a.options.exporterExcelSheetName ? a.options.exporterExcelSheetName : "Sheet1",
                        h = new ExcelBuilder.Worksheet({name: g});
                    f.addWorksheet(h);
                    for (var i = d.prepareAsExcel(a, f, h), j = [], k = a.treeBase ? a.treeBase.numberLevels : 0, l = k; l < a.columns.length; l++) j.push({width: a.columns[l].drawnWidth / 75 * 10});
                    h.setColumns(j);
                    var m = d.getData(a, b, c, a.options.exporterFieldApplyFilters), n = d.formatAsExcel(e, m, f, h, i);
                    h.setData(h.data.concat(n)), ExcelBuilder.Builder.createFile(f, {type: "blob"}).then(function (b) {
                        d.downloadFile(a.options.exporterExcelFilename, b, a.options.exporterCsvColumnSeparator, a.options.exporterOlderExcelCompatibility)
                    })
                })
            }
        };
        ...
        var j = {
            initializeGrid: function (a, b) {
                ...
                if (a.enableGrouping !== !1) {
                    "undefined" == typeof d.grouping && "undefined" != typeof a.grouping ? (d.grouping = angular.copy(a.grouping), "undefined" != typeof d.grouping.groupPriority && d.grouping.groupPriority > -1 && (d.treeAggregationFn = i.nativeAggregations()[b.aggregation.COUNT].aggregationFn,
                        d.treeAggregationFinalizerFn = j.groupedFinalizerFn)) : "undefined" == typeof d.grouping && (d.grouping = {}), "undefined" != typeof d.grouping && "undefined" != typeof d.grouping.groupPriority && d.grouping.groupPriority >= 0 && (d.suppressRemoveSort = !0);
                    var f = {
    ...
    }]), a.directive("uiGridPager", ["uiGridPaginationService", "uiGridConstants", "gridUtil", "i18nService", "i18nConstants", function (a, b, c, d, e) {
        return {
            priority: -200, scope: !0, require: "^uiGrid", link: function (f, g, h, i) {
                var j = ".ui-grid-pager-control-input";
                f.aria = d.getSafeText("pagination.aria");
                var k = function () {
                    f.paginationApi = i.grid.api.pagination, f.sizesLabel = d.getSafeText("pagination.sizes"), f.totalItemsLabel = d.getSafeText("pagination.totalItems"), f.paginationOf = d.getSafeText("pagination.of"), f.paginationThrough = d.getSafeText("pagination.through")
                };
                k(), f.$on(e.UPDATE_EVENT, k);
                var l = i.grid.options;
                i.grid.renderContainers.body.registerViewportAdjuster(function (a) {
                    return l.enablePaginationControls && (a.height = a.height - c.elementHeight(g, "padding")), a
                });
                var m = i.grid.registerDataChangeCallback(function (a) {
                    a.options.useExternalPagination || (a.options.totalItems = a.rows.length)
                }, [b.dataChange.ROW]);
                f.$on("$destroy", m);
                var n = f.$watch("grid.options.paginationCurrentPage + grid.options.paginationPageSize", function (b, c) {
                    return b !== c && void 0 !== c ? !angular.isNumber(l.paginationCurrentPage) || l.paginationCurrentPage < 1 ? void(l.paginationCurrentPage = 1) : l.totalItems > 0 && l.paginationCurrentPage > f.paginationApi.getTotalPages() ? void(l.paginationCurrentPage = f.paginationApi.getTotalPages()) : void a.onPaginationChanged(f.grid, l.paginationCurrentPage, l.paginationPageSize) : void 0
                });
                f.$on("$destroy", function () {
                    n()
                }), f.cantPageForward = function () {
                    return f.paginationApi.getTotalPages() ? f.cantPageToLast() : l.data.length < 1
                }, f.cantPageToLast = function () {
                    var a = f.paginationApi.getTotalPages();
                    return !a || l.paginationCurrentPage >= a
                }, f.cantPageBackward = function () {
                    return l.paginationCurrentPage <= 1
                };
                var o = function (a) {
                    a && c.focus.bySelector(g, j)
                };
                f.pageFirstPageClick = function () {
                    f.paginationApi.seek(1), o(f.cantPageBackward())
                }, f.pagePreviousPageClick = function () {
                    f.paginationApi.previousPage(), o(f.cantPageBackward())
                }, f.pageNextPageClick = function () {
                    f.paginationApi.nextPage(), o(f.cantPageForward())
                }, f.pageLastPageClick = function () {
                    f.paginationApi.seek(f.paginationApi.getTotalPages()), o(f.cantPageToLast())
                }
            }
        }
    }])
        ...
        var e = {
            initializeGrid: function (a) {
                ...
                if (b.enablePinning = void 0 === b.enablePinning ? g.enablePinning : b.enablePinning, b.hidePinLeft = void 0 === b.hidePinLeft ? g.hidePinLeft : b.hidePinLeft, b.hidePinRight = void 0 === b.hidePinRight ? g.hidePinRight : b.hidePinRight, b.pinnedLeft ? (f.renderContainer = "left", f.grid.createLeftContainer()) : b.pinnedRight && (f.renderContainer = "right",
                    ...
                    b.hidePinLeft || a.arrayContainsObjectWithProperty(f.menuItems, "name", "ui.grid.pinning.pinLeft") || f.menuItems.push(h), b.hidePinRight || a.arrayContainsObjectWithProperty(f.menuItems, "name", "ui.grid.pinning.pinRight") || f.menuItems.push(i), a.arrayContainsObjectWithProperty(f.menuItems, "name", "ui.grid.pinning.unpin") || f.menuItems.push(j)
                }
            ...
            link: function (f, g, h, i) {
                ...
                var u = function (a, e) {
                    ...
                    if (h.colDef.enableColumnResizing !== !1) {
                        ...
                        var p = k(h, l);
                        m = p - h.drawnWidth, h.width = p, h.hasCustomWidth = !0, j(m), d.fireColumnSizeChanged(i.grid, h.colDef, m)
                    }
                };
        ...
        var f = {
            initializeGrid: function (a, b) {
                ...
                return a.api.rowEdit.getDirtyRows().forEach(function (b) {
                    f.cancelTimer(a, b), f.saveRow(a, b)(), c.push(b.rowEditSavePromise)
                }), b.all(c)
    ...
    a.constant("uiGridSelectionConstants", {
        ...
        return {
            ...
            link: function (a, d, e, f) {
                ...
                var j = f.grid;
                a.selectButtonClick = h, a.selectButtonKeyDown = g, "ie" === c.detectBrowser() && d.on("mousedown", i), a.$on("$destroy", function () {
                    d.off()
                })
            }
        }
        ...
        return {
            ...
            link: function (a, c, d, e) {
                var f = a.col.grid;
                a.headerButtonKeyDown = function (b) {
                    (32 === b.keyCode || 13 === b.keyCode) && (b.preventDefault(), a.headerButtonClick(b))
                }, a.headerButtonClick = function (a) {
                    f.selection.selectAll ? (b.clearSelectedRows(f, a), f.options.noUnselect && f.api.selection.selectRowByVisibleIndex(0, a), f.selection.selectAll = !1) : f.options.multiSelect && (f.api.selection.selectAllVisibleRows(a), f.selection.selectAll = !0)
                }
            }
        }
        ...
        return {
            priority: -200, scope: !1, compile: function (a, b) {
                var c = angular.element(a[0].querySelector(".ui-grid-canvas:not(.ui-grid-empty-base-layer-container)").children[0]),
                    d = c.attr("ng-class"), e = "";
        ...
        return {
            priority: -200, restrict: "A", require: "?^uiGrid", scope: !1, link: function (a, c, d, e) {
                ...
                e.grid.api.cellNav && e.grid.api.cellNav.on.viewPortKeyDown(a, function (b, c) {
                    null !== c && c.row === a.row && c.col === a.col && 32 === b.keyCode && "selectionRowHeaderCol" === a.col.colDef.name && (b.preventDefault(), f.toggleRowSelection(a.grid, a.row, b, a.grid.options.multiSelect && !a.grid.options.modifierKeysToMultiSelect, a.grid.options.noUnselect), a.$apply())
                });
                var l = function (b) {
    ...
    a.constant("uiGridTreeBaseConstants", {
        ...
        var i = {
            initializeGrid: function (a, b) {
                ...
                "undefined" == typeof c.treeLevel || null === c.treeLevel || c.treeLevel < 0 || (c.treeNode.state === b.EXPANDED ? i.collapseRow(a, c) : i.expandRow(a, c, !1), a.queueGridRefresh())
            }, expandRow: function (a, c, d) {
                if (d) {
                    for (var e = []; c && "undefined" != typeof c.treeLevel && null !== c.treeLevel && c.treeLevel >= 0 && c.treeNode.state !== b.EXPANDED;) e.push(c), c = c.treeNode.parentRow;
                    if (e.length > 0) {
                        for (c = e.pop(); c;) c.treeNode.state = b.EXPANDED, a.api.treeBase.raise.rowExpanded(c), c = e.pop();
                        a.treeBase.expandAll = i.allExpanded(a.treeBase.tree), a.queueGridRefresh()
                    }
                } else {
                    if ("undefined" == typeof c.treeLevel || null === c.treeLevel || c.treeLevel < 0) return;
                    c.treeNode.state !== b.EXPANDED && (c.treeNode.state = b.EXPANDED, a.api.treeBase.raise.rowExpanded(c), a.treeBase.expandAll = i.allExpanded(a.treeBase.tree), a.queueGridRefresh())
                }
