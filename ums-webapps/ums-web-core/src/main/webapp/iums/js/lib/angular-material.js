    ...
    !function () {
        ...
        function o(o, r, a, d, s, c, l, m, u, p) {
            ...
            var v = c.startSymbol(), E = c.endSymbol(), $ = "{{" === v && "}}" === E, C = function (e, n, o) {
                ...
                dom: {}, now: e.performance ? t.bind(e.performance, e.performance.now) : Date.now || function () {
                    ...
                    function a() {
                        var e = s.parentNode, t = e.style.cssText || "", n = s.style.cssText || "", o = y.scrollTop(s),
                            i = s.clientWidth;
        ...
        function e(e, n, o, i, r) {
            this.compile = function (a) {
                var d = a.templateUrl, s = a.template || "", c = a.controller, l = a.controllerAs,
                    m = t.extend({}, a.resolve || {}), u = t.extend({}, a.locals || {}),
                    p = a.transformTemplate || t.identity, h = a.bindToController;
                return t.forEach(m, function (e, n) {
                    ...
                    var n, o = p(e.$template, a), d = a.element || t.element("<div>").html(o.trim()).contents(),
                        s = i(d);
                    return n = {
        ...
        function o(n, o, i) {
            ...
            var m = navigator.userAgent || navigator.vendor || e.opera, u = m.match(/ipad|iphone|ipod/i),
                p = m.match(/android/i), g = c(), b = "undefined" != typeof e.jQuery && t.element === e.jQuery,
        ...
        function a(e, n) {
            ...
            var v = "mousedown touchstart pointerdown", E = "mousemove touchmove pointermove",
        ...
        !function () {
            ...
            var g, b, v, E = /(-gt)?-(sm|md|lg|print)/g, $ = /\s+/g,
                C = ["grow", "initial", "auto", "none", "noshrink", "nogrow"], y = ["row", "column"],
                M = ["", "start", "center", "end", "stretch", "space-around", "space-between"],
                T = ["", "start", "center", "end", "stretch"], A = {enabled: !0, breakpoints: []};
        ...
        e.$inject = ["$mdButtonInkRipple", "$mdCheckboxInkRipple"], o.$inject = ["$scope", "$element", "rippleOptions", "$window", "$timeout", "$mdUtil", "$mdColorUtil"], o.prototype.color = function (e) {
            ...
            if (this.isRippleAllowed()) {
                var i = this, r = i.$mdColorUtil, d = t.element('<div class="md-ripple"></div>'),
                    s = this.$element.prop("clientWidth"), c = this.$element.prop("clientHeight"),
                    l = 2 * Math.max(Math.abs(s - e), e), m = 2 * Math.max(Math.abs(c - n), n),
                    u = o(this.options.fitRipple, l, m), p = this.calculateColor();
                d.css({
                    left: e + "px",
                    top: n + "px",
                    background: "black",
        ...
        !function (e) {
            ...
            function o(t) {
                ...
                function l(t, o) {
                    ...
                    function r(n, r) {
                        ...
                        var c = r.controller("mdTheme"), l = n.attr("md-theme-watch"),
            ...
            function d(t, n, o) {
                ...
                var i = [], r = t.colors[n], a = new RegExp("\\.md-" + t.name + "-theme", "g"),
            ...
            function s(t, n) {
                function o(t, n) {
                    var o = t.contrastDefaultColor, i = t.contrastLightColors || [],
                        r = t.contrastStrongLightColors || [], a = t.contrastDarkColors || [];
                ...
                var i = document.head, r = i ? i.firstElementChild : null,
            ...
            var p, h = {}, f = {
                ...
                }, b = "1px 1px 0px rgba(0,0,0,0.4), -1px -1px 0px rgba(0,0,0,0.4)", v = "", E = m("rgba(0,0,0,0.87)"),
                $ = m("rgba(255,255,255,0.87)"), C = m("rgb(255,255,255)"),
                y = ["primary", "accent", "warn", "background"], M = "primary", T = {
                ...
                translate3d: function (e, t, n, o) {
                    ...
                    if (o || i) {
                        var r = o ? d.clientRect(o) || n() : d.copyRect(i),
                            a = d.copyRect(e[0].getBoundingClientRect()), s = d.centerPointFor(a),
        ...
        t.version.minor >= 4 ? t.module("material.core.animate", []) : !function () {
            ...
            t.module("material.core.animate", []).factory("$$forceReflow", d).factory("$$AnimateRunner", c).factory("$$rAFMutex", s).factory("$animateCss", ["$window", "$$rAF", "$$AnimateRunner", "$$forceReflow", "$$jqLite", "$timeout", "$animate", function (t, d, s, c, l, m, u) {
                ...
                function f(e) {
                    ...
                    var i = C(e), r = t.getComputedStyle(i), a = g(r[n("transitionDuration")]),
        ...
        !function () {
                ...
                function i(n) {
                    if (!n.hasClass("md-animations-waiting") || n.hasClass("_md-animations-ready")) {
                        var o = n[0], i = n.controller("mdFabSpeedDial"), r = o.querySelectorAll(".md-fab-action-item"),
                            a = o.querySelector("md-fab-trigger"), d = o.querySelector("._md-css-variables"),
            ...
            function i(n) {
                ...
                function i(n) {
                    var o = n[0], i = n.controller("mdFabSpeedDial"), r = o.querySelectorAll(".md-fab-action-item"),
                        d = o.querySelector("._md-css-variables"), s = parseInt(e.getComputedStyle(d).zIndex);
                    t.forEach(r, function (e, t) {
                        var n = e.style, o = t * a;
            ...
            function o() {
                function n(n, o, i) {
                    if (o) {
                        ...
                        if (s && d) {
                            var u = e.getComputedStyle(s).getPropertyValue("background-color"), p = r.offsetWidth,
        ...
        function e(e, o, i, r) {
            function a(n, a, d, s) {
                ...
                n.$on("$destroy", l);
                var A, w = e.startSymbol(), k = e.endSymbol(),
        ...
        function i(e, n, o, i, r) {
            function a(a, d, s, c) {
                ...
                function p() {
                    ...
                    function u() {
                        ...
                        if (!s.hasOwnProperty("mdNoResize")) {
                            var l = t.element('<div class="md-resize-handle"></div>'), u = !1, p = null, f = 0,
                                g = h.element, b = r.register(l, "drag", {horizontal: !1});
                    ...
                    if (u(), p) {
                        var b = s.hasOwnProperty("rows") ? parseInt(s.rows) : NaN,
                            ...
                            E = a.$on("md-resize-textarea", o), $ = null, C = d[0];
                        if (i(function () {
                                e.nextTick(o)
                ...
                var h = c[0], f = !!c[1], g = c[1] || e.fakeNgModel(), b = c[2], v = t.isDefined(s.readonly),
                    E = e.parseAttributeBoolean(s.mdNoAsterisk), $ = d[0].tagName.toLowerCase();
                if (h) {
        ...
        function f(t) {
            var n = parseInt(e.getComputedStyle(t[0]).height), o = parseInt(e.getComputedStyle(t[0]).marginTop),
                i = v(t), r = b(t), a = o > -n;
            ...
            return {
                restrict: "E", controller: "MdListController", compile: function (a, d) {
                    ...
                    function b(e, a, d, s) {
                        ...
                        a.addClass("_md");
                        var u = [], p = a[0].firstElementChild, h = a.hasClass("_md-button-wrap"),
                            f = h ? p.firstElementChild : p, b = f && g(f);
        ...
        function e(e, n, o) {
            ...
            function r(o, i, r) {
                ...
                e(i);
                var g, b = r.hasOwnProperty("disabled"), v = n.dom.animator.toCss,
                    E = t.element(i[0].querySelector(".md-bar1")), $ = t.element(i[0].querySelector(".md-bar2")),
        ...
        function o(e, o, i, r, a, d, s) {
            function c(d, c) {
                ...
                var p = o.parseAttributeBoolean(c.multiple), h = p ? "multiple" : "",
                ...
                return f = o.supplant(f, [h, d.html()]), d.empty().append(l), d.append(f), c.tabindex || c.$set("tabindex", 0), function (d, c, l, m) {
                    ...
                    var $, C, y = !0, M = m[0], T = m[1], A = m[2], w = m[3], k = c.find("md-select-value"),
                        _ = t.isDefined(l.readonly), x = o.parseAttributeBoolean(l.mdNoAsterisk);
                    if (M) {
        ...
        function i(e, o, i, r) {
            ...
            function d(r, a, d) {
                ...
                m.optNodeForKeyboardSearch = function (e) {
                    ...
                    var i = m.ngModel.$options && m.ngModel.$options.trackBy, r = m.isMultiple ? n : n[0],
        ...
        function s(o) {
            function i(o, i, l, m, u, p, h, f, g) {
                ...
                function $(n, o, i) {
                    var u, p = o[0], h = i.target[0].children[0], f = g[0].body, b = i.selectEl[0], v = i.contentEl[0],
                        E = f.getBoundingClientRect(), $ = h.getBoundingClientRect(), C = !1, y = {
                            left: E.left + c,
                            top: c,
                            bottom: E.height - c,
                        ...
                        }, T = E.width - 2 * c, A = b.querySelector("md-option[selected]"),
                        w = b.getElementsByTagName("md-option"), k = b.getElementsByTagName("md-optgroup"), _ = s(o, v),
                        x = r(i.loadingAsync);
                    ...
                    var B = p.getBoundingClientRect(), U = Math.round(100 * Math.min($.width / N.width, 1)) / 100,
        ...
        function o(e, n, o, i, r, a, d, s, c, l) {
            ...
            function u(o, m, u, p) {
                ...
                var W = p[0] || {
                    ...
                    G = t.element(m[0].querySelector(".md-thumb-text")), X = K.parent(),
                    ...
                    te = (t.element(m[0].getElementsByClassName("md-slider-content")), i.throttle(y, 5e3)), ne = 3,
                    oe = t.isDefined(u.mdVertical), ie = t.isDefined(u.mdDiscrete), re = t.isDefined(u.mdInvert);
            ...
            return {
                template: "", restrict: "E", link: function (d, s, c) {
                    function l() {
                        ...
                        var h, f, g = t.noop, b = 0, v = 0, E = c.mdShrinkSpeedFactor || .5, $ = e.throttle(m),
                            C = o.debounce(p, 5e3);
        ...
        function e(e, n, o, i, r, a, d, s, c, l) {
            function m(d, c, m) {
                ...
                a(c);
                var x = r.getParentWithPointerEvents(c), S = t.element(c[0].getElementsByClassName("md-content")[0]),
                    N = t.element(document.body), D = null, H = o.throttle(function () {
                        k()
                    });
        ...
        function e(e, o, d, s, c, l, m, u, p, h, f) {
            ...
            function v() {
                ...
                var s, c = $e.wrap.getBoundingClientRect(), l = $e.snap.getBoundingClientRect(),
                    m = $e.root.getBoundingClientRect(), u = l.bottom - m.top, h = m.bottom - l.top,
                    f = c.left - m.left, g = c.width, b = t();
            ...
            function le() {
                if ($e.li[0]) {
                    var e = $e.li[0].offsetHeight, t = e * be.index, n = t + e, o = $e.scroller.clientHeight,
            ...
            var be = this, ve = e.itemsExpr.split(/ in /i), Ee = ve[1], $e = null, Ce = {}, ye = !1, Me = [], Te = !1,
                Ae = 0, we = 0, ke = null, _e = null;
        ...
        function e(e, t, a, d, s, c) {
            function l(n, o) {
                ...
                var l = i("md-chips>md-chip-template"), m = t.prefixer().buildList("md-chip-remove").map(function (e) {
                        return "md-chips>*[" + e + "]"
                    }).join(","), p = i(m) || u.remove, h = l || u["default"],
                    f = i("md-chips>md-autocomplete") || i("md-chips>input") || u.input, g = r.find("md-chip");
        ...
        !function () {
            ...
            t.module("material.components.datepicker").directive("mdCalendarMonthBody", e), e.$inject = ["$compile", "$$mdSvgRegistry"], n.$inject = ["$element", "$$mdDateUtil", "$mdDateLocale"], n.prototype.generateContent = function () {
                ...
                r.appendChild(d);
                var s = this.offset === this.monthCtrl.items.length - 1, c = 0, l = document.createElement("td"),
        ...
        !function () {
            ...
            t.module("material.components.datepicker").directive("mdCalendarYearBody", e), n.$inject = ["$element", "$$mdDateUtil", "$mdDateLocale"], n.prototype.generateContent = function () {
                ...
                var t, n = e.getFullYear(), o = document.createDocumentFragment(), i = document.createElement("tr"),
        ...
        !function () {
            ...
            var i = 3, r = "md-datepicker-invalid", a = "md-datepicker-open", d = "_md-datepicker-floating-label",
                s = "_md-datepicker-has-calendar-icon", c = 500, l = 368, m = 360;
            o.$inject = ["$scope", "$element", "$attrs", "$window", "$mdConstant", "$mdTheming", "$mdUtil", "$mdDateLocale", "$$mdDateUtil", "$$rAF", "$mdGesture"], o.prototype.configureNgModel = function (e, n) {
                ...
                var o = this.inputContainer.getBoundingClientRect(), i = n.getBoundingClientRect(), r = o.top - i.top,
                    d = o.left - i.left,
                    ...
                    u = s + this.$window.innerHeight, p = c + this.$window.innerWidth;
                if (d + m > p) {
                    if (p - m > 0) d = p - m; else {
                        d = c;
        ...
        function e(e) {
            function o(e, o, a, d, s, c, l, m, u) {
                ...
                function E(t, o) {
                    ...
                    var c, l = t[0], m = t[0].firstElementChild, u = m.getBoundingClientRect(), p = d[0].body,
                        h = p.getBoundingClientRect(), f = s.getComputedStyle(m),
                        g = o.target[0].querySelector($.buildSelector("md-menu-origin")) || o.target[0],
                        b = g.getBoundingClientRect(), v = {
                            left: h.left + r,
                            top: Math.max(h.top, 0) + r,
                            bottom: Math.max(h.bottom, Math.max(h.top, 0) + h.height) - r,
                            right: h.right - r
                        }, E = {top: 0, left: 0, right: 0, bottom: 0}, C = {top: 0, left: 0, right: 0, bottom: 0},
        ...
        function e(e, n, o, i, r, a) {
            function d(a, d, c) {
                function f(t, o, r, d, c) {
                    var l = ++N, h = i.now(), f = o - t, g = m(a.mdDiameter), b = g - u(g), v = r || n.easeFn,
                        E = d || n.duration;
                ...
                var M, T, A = d[0], w = t.element(A.querySelector("svg")), k = t.element(A.querySelector("path")),
                    _ = n.startIndeterminate, x = n.endIndeterminate, S = 0, N = 0;
            ...
            function s(e, t, n, o) {
                var i, r = 3.5999, a = o || 0, d = t / 2, s = n / 2, l = a * r, m = e * r, u = c(d, s, l),
                    p = c(d, s, m + l), h = m < 0 ? 0 : 1;
            ...
            var p = e.requestAnimationFrame || t.noop, h = e.cancelAnimationFrame || t.noop, f = e.Math.PI / 180,
                g = "determinate", b = "indeterminate", v = "_md-progress-circular-disabled",
        ...
        function e(e, o, i, r, a, d, s, c, l, m) {
            ...
            function re() {
                ...
                var e = F(), t = e.contents[le.selectedIndex], i = t ? t.offsetHeight : 0, r = e.wrapper.offsetHeight,
                    a = i + r, c = o.prop("clientHeight");
                if (c !== a) {
            ...
            function ae() {
                ...
                var n = le.selectedIndex, i = e.paging.offsetWidth, r = e.tabs[n], a = r.offsetLeft,
                    s = i - a - r.offsetWidth;
