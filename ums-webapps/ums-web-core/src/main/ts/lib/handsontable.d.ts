...
/// <reference path="jquery.d.ts"/>
  interface Options {
     ...
     */
    beforeAutofill?: (start: any, end: any, data: string[][]) => void;
     ...
     */
    afterOnCellMouseDown?: (event: MouseEvent, coords: any, TD: HTMLTableDataCellElement) => void;
     ...
     */
    afterOnCellMouseOver?: (event: MouseEvent, coords: any, TD: HTMLTableDataCellElement) => void;
...
interface JQuery {
  ...
  handsontable(options: Options): JQuery;
}
