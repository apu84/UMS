...
public class MutableRecordResource extends Resource {
  ...
  public Response updateRecord(@Context HttpServletRequest pHttpServletRequest, final @PathParam("object-id") Long pObjectId, final @Context Request pRequest,
  ...
  public Response createRecord(@Context HttpServletRequest pHttpServletRequest, final JsonObject pJsonObject) throws Exception {
  ...
  public Response deleteRecord(@Context HttpServletRequest pHttpServletRequest, final @PathParam("object-id") String pMfnNo) throws Exception {
