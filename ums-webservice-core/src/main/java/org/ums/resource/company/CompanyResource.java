...
public class CompanyResource extends Resource{
  ...
  public JsonObject saveCompany(@Context HttpServletRequest pHttpServletRequest, JsonObject pJsonObject) throws Exception{
    return mCompanyResourceHelper.save(pJsonObject, mUriInfo);
  }

  @PUT
  @PostLog(message = "Requested for updating company")
  public JsonObject updateCompany(@Context HttpServletRequest pHttpServletRequest, JsonObject pJsonObject) throws Exception{
