...
import org.ums.resource.helper.SemesterResourceHelper;
...
public class MutableSemesterResource extends Resource {
  ...
  public Response updateSemester(final @PathParam("object-id") String pObjectId, final @Context Request pRequest,
