...
public class PersonalInformationBuilder implements Builder<PersonalInformation, MutablePersonalInformation> {
  ...
  public void build(JsonObjectBuilder pBuilder, PersonalInformation pReadOnly, UriInfo pUriInfo, LocalCache pLocalCache) {
    ...
    generalObjectBuilder.add(
        "salutation",
        Json.createObjectBuilder().add("id", pReadOnly.getSalutationId())
            .add("name", Salutation.get(pReadOnly.getSalutationId()).getLabel()));
    ...
    if(pReadOnly.getGender() == null) {
      ...
      generalObjectBuilder.add(
          "gender",
          pReadOnly.getGender().equals("M") ? Json.createObjectBuilder().add("id", pReadOnly.getGender())
              .add("name", "Male") : Json.createObjectBuilder().add("id", pReadOnly.getGender()).add("name", "Female"));
    }
    ...
    if(pReadOnly.getNationalityId() == 0 || pReadOnly.getNationalityId() == null) {
      ...
      generalObjectBuilder.add(
          "nationality",
          Json.createObjectBuilder().add("id", pReadOnly.getNationalityId())
              .add("name", NationalityType.get(pReadOnly.getNationalityId()).getLabel()));
    }
    if(pReadOnly.getReligionId() == 0 || pReadOnly.getReligionId() == null) {
      ...
      generalObjectBuilder.add(
          "religion",
          Json.createObjectBuilder().add("id", pReadOnly.getReligionId())
              .add("name", ReligionType.get(pReadOnly.getReligionId()).getLabel()));
    }
    if(pReadOnly.getMaritalStatusId() == 0 || pReadOnly.getMaritalStatusId() == null) {
      generalObjectBuilder.add("maritalStatus", JsonValue.NULL);
    }
    else {
      generalObjectBuilder.add("maritalStatus", Json.createObjectBuilder().add("id", pReadOnly.getMaritalStatusId())
          .add("name", MaritalStatusType.get(pReadOnly.getMaritalStatusId()).getLabel()));
    }
    ...
    if(pReadOnly.getBloodGroupId() == 0 || pReadOnly.getBloodGroupId() == null) {
      ...
      generalObjectBuilder.add(
          "bloodGroup",
          Json.createObjectBuilder().add("id", pReadOnly.getBloodGroupId())
              .add("name", BloodGroupType.get(pReadOnly.getBloodGroupId()).getLabel()));
    }
    ...
    contactObjectBuilder.add("preAddressLine1",
        pReadOnly.getPresentAddressLine1() == null ? "" : pReadOnly.getPresentAddressLine1());
    if(pReadOnly.getPresentAddressCountryId() == 0 || pReadOnly.getPresentAddressCountryId() == null) {
      ...
      contactObjectBuilder.add(
          "preAddressCountry",
          Json.createObjectBuilder().add("id", pReadOnly.getPresentAddressCountryId())
              .add("name", mCountryManager.get(pReadOnly.getPresentAddressCountryId()).getName()));
    }
    if((pReadOnly.getPresentAddressCountryId() != 0 && pReadOnly.getPresentAddressCountryId() != null)) {
      if(mCountryManager.get(pReadOnly.getPresentAddressCountryId()).getName().equals("Bangladesh")) {
        if(pReadOnly.getPresentAddressDivisionId() == 0 || pReadOnly.getPresentAddressDivisionId() == null) {
          ...
          contactObjectBuilder.add(
              "preAddressDivision",
              Json.createObjectBuilder().add("id", pReadOnly.getPresentAddressDivisionId())
                  .add("name", mDivisionManager.get(pReadOnly.getPresentAddressDivisionId()).getDivisionName()));
        }
        if(pReadOnly.getPresentAddressDistrictId() == 0 || pReadOnly.getPresentAddressDistrictId() == null) {
          ...
          contactObjectBuilder.add(
              "preAddressDistrict",
              Json.createObjectBuilder().add("id", pReadOnly.getPresentAddressDistrictId())
                  .add("name", mDistrictManager.get(pReadOnly.getPresentAddressDistrictId()).getDistrictName()));
        }
        if(pReadOnly.getPresentAddressThanaId() == 0 || pReadOnly.getPresentAddressThanaId() == null) {
          ...
          contactObjectBuilder.add(
              "preAddressThana",
              Json.createObjectBuilder().add("id", pReadOnly.getPresentAddressThanaId())
                  .add("name", mThanaManager.get(pReadOnly.getPresentAddressThanaId()).getThanaName()));
        }
      }
      else {
        contactObjectBuilder.add("preAddressDivision", JsonValue.NULL);
    ...
    contactObjectBuilder.add("perAddressLine1",
        pReadOnly.getPermanentAddressLine1() == null ? "" : pReadOnly.getPermanentAddressLine1());
    if(pReadOnly.getPermanentAddressCountryId() == 0 || pReadOnly.getPermanentAddressCountryId() == null) {
      ...
      contactObjectBuilder.add(
          "perAddressCountry",
          Json.createObjectBuilder().add("id", pReadOnly.getPermanentAddressCountryId())
              .add("name", mCountryManager.get(pReadOnly.getPermanentAddressCountryId()).getName()));
    }
    if((pReadOnly.getPermanentAddressCountryId() != 0 && pReadOnly.getPermanentAddressCountryId() != null)) {
      if(mCountryManager.get(pReadOnly.getPermanentAddressCountryId()).getName().equals("Bangladesh")) {
        if(pReadOnly.getPermanentAddressDivisionId() == 0 || pReadOnly.getPermanentAddressDivisionId() == null) {
          ...
          contactObjectBuilder.add(
              "perAddressDivision",
              Json.createObjectBuilder().add("id", pReadOnly.getPermanentAddressDivisionId())
                  .add("name", mDivisionManager.get(pReadOnly.getPermanentAddressDivisionId()).getDivisionName()));
        }
        if(pReadOnly.getPermanentAddressDistrictId() == 0 || pReadOnly.getPermanentAddressDistrictId() == null) {
          ...
          contactObjectBuilder.add(
              "perAddressDistrict",
              Json.createObjectBuilder().add("id", pReadOnly.getPermanentAddressDistrictId())
                  .add("name", mDistrictManager.get(pReadOnly.getPermanentAddressDistrictId()).getDistrictName()));
        }
        if(pReadOnly.getPermanentAddressThanaId() == 0 || pReadOnly.getPermanentAddressThanaId() == null) {
          ...
          contactObjectBuilder.add(
              "perAddressThana",
              Json.createObjectBuilder().add("id", pReadOnly.getPermanentAddressThanaId())
                  .add("name", mThanaManager.get(pReadOnly.getPermanentAddressThanaId()).getThanaName()));
        }
      }
      else {
        contactObjectBuilder.add("perAddressDivision", JsonValue.NULL);
    ...
    emergencyContactObjectBuilder.add("emergencyContactName", pReadOnly.getEmergencyContactName() == null ? ""
        : pReadOnly.getEmergencyContactName());
    if(pReadOnly.getEmergencyContactRelationId() == 0 || pReadOnly.getEmergencyContactRelationId() == null) {
      ...
      emergencyContactObjectBuilder.add(
          "emergencyContactRelation",
          Json.createObjectBuilder().add("id", pReadOnly.getEmergencyContactRelationId())
              .add("name", RelationType.get(pReadOnly.getEmergencyContactRelationId()).getLabel()));
    }
    emergencyContactObjectBuilder.add("emergencyContactPhone", pReadOnly.getEmergencyContactPhone() == null ? ""
        : pReadOnly.getEmergencyContactPhone());
  ...
  public void build(MutablePersonalInformation pMutable, JsonObject pJsonObject, LocalCache pLocalCache) {
    ...
    if(pJsonObject.getString("type").equals("general")) {
      ...
      pMutable.setDateOfBirth(pJsonObject.getString("dateOfBirth").isEmpty() ? null : mDateFormat.parse(pJsonObject
          .getString("dateOfBirth")));
      pMutable.setNationalityId(pJsonObject.get("nationality").equals(JsonValue.NULL) ? null : pJsonObject
          .getJsonObject("nationality").getInt("id"));
      pMutable.setReligionId(pJsonObject.get("religion").equals(JsonValue.NULL) ? null : pJsonObject.getJsonObject(
          "religion").getInt("id"));
      pMutable.setMaritalStatusId(pJsonObject.get("maritalStatus").equals(JsonValue.NULL) ? null : pJsonObject
          .getJsonObject("maritalStatus").getInt("id"));
      ...
      pMutable.setBloodGroupId(pJsonObject.get("bloodGroup").equals(JsonValue.NULL) ? null : pJsonObject.getJsonObject(
          "bloodGroup").getInt("id"));
    ...
    if(pJsonObject.getString("type").equals("contact")) {
      ...
      pMutable.setPresentAddressCountryId(pJsonObject.get("preAddressCountry").equals(JsonValue.NULL) ? null
          : pJsonObject.getJsonObject("preAddressCountry").getInt("id"));
      if(!pJsonObject.get("preAddressCountry").equals(JsonValue.NULL)
          && pJsonObject.getJsonObject("preAddressCountry").getString("name").equals("Bangladesh")) {
        pMutable.setPresentAddressDivisionId(pJsonObject.get("preAddressDivision").equals(JsonValue.NULL) ? null
            : pJsonObject.getJsonObject("preAddressDivision").getInt("id"));
        pMutable.setPresentAddressDistrictId(pJsonObject.get("preAddressDistrict").equals(JsonValue.NULL) ? null
            : pJsonObject.getJsonObject("preAddressDistrict").getInt("id"));
        pMutable.setPresentAddressThanaId(pJsonObject.get("preAddressThana").equals(JsonValue.NULL) ? null
            : pJsonObject.getJsonObject("preAddressThana").getInt("id"));
      ...
      pMutable.setPermanentAddressCountryId(pJsonObject.get("perAddressCountry").equals(JsonValue.NULL) ? null
          : pJsonObject.getJsonObject("perAddressCountry").getInt("id"));
      if(!pJsonObject.get("perAddressCountry").equals(JsonValue.NULL)
          && pJsonObject.getJsonObject("perAddressCountry").getString("name").equals("Bangladesh")) {
        pMutable.setPermanentAddressDivisionId(pJsonObject.get("perAddressDivision").equals(JsonValue.NULL) ? null
            : pJsonObject.getJsonObject("perAddressDivision").getInt("id"));
        pMutable.setPermanentAddressDistrictId(pJsonObject.get("perAddressDistrict").equals(JsonValue.NULL) ? null
            : pJsonObject.getJsonObject("perAddressDistrict").getInt("id"));
        pMutable.setPermanentAddressThanaId(pJsonObject.get("perAddressThana").equals(JsonValue.NULL) ? null
            : pJsonObject.getJsonObject("perAddressThana").getInt("id"));
    ...
    if(pJsonObject.getString("type").equals("emergencyContact")) {
      ...
      pMutable.setEmergencyContactRelationId(pJsonObject.get("emergencyContactRelation").equals(JsonValue.NULL) ? null
          : pJsonObject.getJsonObject("emergencyContactRelation").getInt("id"));
