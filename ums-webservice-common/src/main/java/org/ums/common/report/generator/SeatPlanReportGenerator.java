...
public interface SeatPlanReportGenerator {
  ...
  void createSeatPlanAttendenceReport(Integer pProgramType, Integer pSemesterId,Integer pExamType, String pExamDate)throws Exception,IOException,DocumentException;
}
