...
public class SubGroupResource extends MutableSubGroupResource{
  ...
  public JsonObject getBySemesterAndGroupNo(final @Context Request pRequest,
                                            final @PathParam("semesterId") int pSemesterId,
                                            final @PathParam("groupNo") int pGroupNo,
                                            final @PathParam("type") String type
                                            )throws Exception{
    return mSubGroupResourceHelper.getBySemesterAndGroupNO(pSemesterId,pGroupNo,Integer.parseInt(type),pRequest,mUriInfo);
  }
  @GET
