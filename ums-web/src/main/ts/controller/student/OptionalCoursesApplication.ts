module ums {
  ...
  var map = {};
  map["application"] = "academic/optional/application/student";
  map["application_save_submit"] = "academic/optional/application/student/{STATUS-ID}";
  ...
  export class OptionalCoursesApplication {
    ...
    constructor(private appConstants: any, private httpClient: HttpClient, private $scope: IOptCourseApplication, private $q: ng.IQService) {
      ...
      this.getApplication(map["application"]).then((json: any)=> {
    ...
    private saveOrSubmitApplication(statusId: number) {
      var courseList: Array<IOptCourse> = [];
      ...
      var url = map["application_save_submit"];
